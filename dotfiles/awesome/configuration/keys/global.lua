...
local globalKeys =
  ...
  awful.key(
    ...
    -- Win+Alt+[/] : move client to prev/next tag and switch to it
	...
	awful.key({ modkey, 'Shift' }, "[",
		function ()
			...
			{description = "move client to previous tag and switch to it", group = "client"}),
	awful.key({ modkey, 'Shift' }, "]",
		function ()
			-- get current tag
			local t = client.focus and client.focus.first_tag or nil
			...
			{description = "move client to next tag and switch to it", group = "client"}),
